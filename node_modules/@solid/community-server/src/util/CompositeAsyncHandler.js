...
exports.CompositeAsyncHandler = void 0;
...
class CompositeAsyncHandler {
    ...
    async findHandler(input) {
        ...
        throw new UnsupportedHttpError_1.UnsupportedHttpError(`No handler supports the given input: [${joined}].`);
    }
}
exports.CompositeAsyncHandler = CompositeAsyncHandler;
//# sourceMappingURL=CompositeAsyncHandler.js.map